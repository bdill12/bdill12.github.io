...
var JobsComponent = (function () {
    function JobsComponent(infoService, router) {
        this.infoService = infoService;
        this.router = router;
        this.title = "Experience";
        this.heading = '"I just believe that the interesting time in a career is pre-success, what shaped things, how did you get to this point?"';
        this.subheading = "- Steve Martin";
    }
