...
var GameService = (function () {
    function GameService(http) {
        ...
        this.scoreUrl = 'api/score'; // URL to web api
        this.newGameUrl = 'api/newGameModal';
    }
    ...
    GameService.prototype.newGameModal = function () {
        return this.http.get(this.newGameUrl)
            .toPromise()
            .then(function (response) { return response.json().data; })
            .catch(this.handleError);
    };
    GameService.prototype.updateScore = function (scoreboard) {
        return this.http
            .put(scoreUrl, JSON.stringify(scoreboard), { headers: this.headers })
            .toPromise()
            .then(function () { return scoreboard; })
            .catch(this.handleError);
    };
